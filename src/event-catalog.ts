...
export const EVENT_LABELS: Record<string, string> = {
  ...
  memory_vector_delete_failed: 'Memory vector delete failed',
  memory_vector_batch_delete_failed: 'Memory vector batch delete failed',
  memory_entity_vector_batch_delete_failed: 'Memory entity vector batch delete failed',
  memory_entity_vector_sync_failed: 'Memory entity vector sync failed',
  memory_relation_vector_sync_failed: 'Memory relation vector sync failed',
  memory_candidate_source_failed: 'Memory candidate source failed',
  memory_llm_model_fallback: 'Memory LLM model fallback',
  memory_update_decision_failed: 'Memory update decision failed',
  memory_relation_write_failed: 'Memory relation write failed',
  memory_write_failed: 'Memory write failed',
  memory_update_similarity_embedding_failed: 'Memory update similarity embedding failed',
  memory_llm_update_decision_failed: 'Memory LLM update decision failed',
  memory_duplicate_lookup_failed: 'Memory duplicate lookup failed',
  memory_entity_vector_recall_failed: 'Memory entity vector recall failed',
  memory_graph_lookup_failed: 'Memory graph lookup failed',
  memory_profile_stats_publish_failed: 'Memory profile stats publish failed',
  memory_ops_event_publish_failed: 'Memory ops event publish failed',
  ...
  agent_incident: 'Agent incident',
  usage_limit_blocked: 'Usage limit blocked',
  usage_recorded: 'Usage threshold recorded',
  subagent_turn: 'Sub-agent turn completed',
